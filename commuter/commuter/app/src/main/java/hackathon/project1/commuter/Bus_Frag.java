...
public class Bus_Frag extends FragmentActivity implements OnMapReadyCallback,
...
//                }
            ...
            case R.id.Go:
                ...
                Toast.makeText(Bus_Frag.this, "Showing Nearby Bustops", Toast.LENGTH_LONG).show();
                break;
